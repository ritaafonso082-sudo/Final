    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-24 md:pt-20 overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 md:px-6 w-full pb-10 md:pb-20">
        <motion.div 
          ...
          className="max-w-3xl"
        >
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-white leading-none mb-3 md:mb-4 tracking-tight flex flex-col items-start">
          ...
          <div className="mb-6 md:mb-8 flex flex-col gap-3 md:gap-4">
            ...
            <div className="flex items-center gap-3 sm:gap-4 md:gap-6">
              <div className="flex flex-col items-center">
                <span className="text-[#FFB800] text-2xl sm:text-3xl md:text-4xl font-black" translate="no">{pad(timeLeft.days)}</span>
              ...
              <div className="flex flex-col items-center">
                <span className="text-[#FFB800] text-2xl sm:text-3xl md:text-4xl font-black" translate="no">{pad(timeLeft.hours)}</span>
                <span className="text-gray-400 text-[8px] sm:text-[10px] tracking-widest">HOURS</span>
              </div>
              <span className="text-white/20 text-xl sm:text-2xl font-light pb-2 sm:pb-3">:</span>
              <div className="flex flex-col items-center">
                <span className="text-[#FFB800] text-2xl sm:text-3xl md:text-4xl font-black" translate="no">{pad(timeLeft.minutes)}</span>
                <span className="text-gray-400 text-[8px] sm:text-[10px] tracking-widest">MINS</span>
              </div>
              <span className="text-white/20 text-xl sm:text-2xl font-light pb-2 sm:pb-3">:</span>
              <div className="flex flex-col items-center">
                <span className="text-[#FFB800] text-2xl sm:text-3xl md:text-4xl font-black" translate="no">{pad(timeLeft.seconds)}</span>
