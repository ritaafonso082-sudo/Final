    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-24 md:pt-20 overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 md:px-6 w-full pb-10 md:pb-20">
        ...
        >
          ...
          <p className="text-gray-300 text-sm sm:text-base md:text-lg mb-6 md:mb-8 max-w-xl leading-relaxed whitespace-pre-line">
            <Trans i18nKey="hero.subtitle" values={{ brand: 'Real Builder' }}>
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <span className="text-white font-medium tracking-wide text-xs sm:text-sm uppercase">
                {timeLeft.days === 0 && timeLeft.hours === 0 && timeLeft.minutes === 0 && timeLeft.seconds === 0 
                  ...
                  : (
                    <span>
                      <Trans i18nKey="hero.registrationsOpenIn">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full">
            ...
            >
              ...
              />
              <span className="relative z-10">{t('hero.exploreCourses')}</span>
            </motion.button>
            ...
            >
              <span className="relative z-10">{t('hero.notifyMe')}</span>
            </motion.button>
          </div>
        </motion.div>
      </div>
