      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert max-w-none text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>
              Welcome to Real Builder Academy. These Terms and Conditions govern the access and use of our website and the services provided by Real Builder Academy, headquartered at Avenida Mateus Teixeira Azevedo 55, Tavira, Portugal.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Real Builder Academy offers professional training courses in the construction industry, including, but not limited to, drywall installation, tiling, and underfloor heating installation.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              All content present on this website, including texts, graphics, logos, icons, images, audio clips, digital downloads, and data compilations, is the property of Real Builder Academy or its content suppliers and is protected by Portuguese and international copyright laws.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Real Builder Academy makes every effort to ensure that the information presented on the website is accurate and up-to-date. However, we do not guarantee the absence of errors or omissions.
            </p>
            <p>
              Real Builder Academy shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use this website or the services offered.
            </p>
          </section>
